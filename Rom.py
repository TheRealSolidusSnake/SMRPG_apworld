...
location_data: Dict[str, MemoryLocation] = dict({
    ...
    "Chest - Bowser's Keep Invisible Bridge 1": MemoryLocation(treasure_chest_base_address + 15, 7, False),  # the exact order of chests within rooms seems to change between generations for chests after doors...
    ...
    "Chest - Bowser's Keep Elevator Platforms": MemoryLocation(treasure_chest_base_address + 15, 6, False),
    "Chest - Bowser's Keep Cannonball Room 1": MemoryLocation(treasure_chest_base_address + 23, 4, False),
    "Chest - Bowser's Keep Cannonball Room 2": MemoryLocation(treasure_chest_base_address + 23, 5, False),
    "Chest - Bowser's Keep Cannonball Room 3": MemoryLocation(treasure_chest_base_address + 23, 1, False), 
    "Chest - Bowser's Keep Cannonball Room 4": MemoryLocation(treasure_chest_base_address + 23, 2, False),
    "Chest - Bowser's Keep Cannonball Room 4": MemoryLocation(treasure_chest_base_address + 23, 2, False),
    "Chest - Bowser's Keep Cannonball Room 5": MemoryLocation(treasure_chest_base_address + 23, 3, False),
    ...
    "Chest - Bowser's Keep Door Reward 1": MemoryLocation(treasure_chest_base_address + 7, 4, False), # first chest always seems to be 1 regardless which door you pick?
    "Chest - Bowser's Keep Door Reward 2": MemoryLocation(treasure_chest_base_address + 21, 7, False),
    "Chest - Bowser's Keep Door Reward 3": MemoryLocation(treasure_chest_base_address + 0, 0, False),
    ...
    "Chest - Factory Falling Axems": MemoryLocation(treasure_chest_base_address + 0, 0, False), # map me
